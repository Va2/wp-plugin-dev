<?php
// Dès qu'on fait appel a une class comme c'est le cas à la ligne 25 du fichier ratatouille.php la fonction spl_autoload_register est automatiquement lancée, elle lance à son tour la fonction qu'elle à en paramètre 'simplarity_autoloader' et à la même occasion elle remplie le paramètre de la fonction simplarity_autoloader avec la classe qui la lancée.
...
function simplarity_autoloader($class_name)
{
    ...
    if (strpos($class_name, 'App') !== false) {
        ...
        // On modifie la syntaxe de la class name pour passé de "App\Features\PostTypes\RecipePostType" par "App/Features/PostTypes/RecipePostType.php" voila ce que fait la combinaison de la fonction str_replace et de l'argument DIRECTORY_SEPARATOR 
