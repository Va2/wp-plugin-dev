...
// Minimum requis pour que le plugin (après avoir été activé dans les plugins) apparaissent dans le menu de gauche (du backoffice).
...
function register_recipe_post_type(){
    // register_post_type permet de rajouter un post-type dans le menu du backoffice. De base il existe des post type tel que 'PAGE' ou 'POST'(article) et bien d'autres... Notre but va être de créer un nouveau post type qui sera 'Recipe'.
    ...
    register_post_type('recipe',
        [
            ...
            'labels' => [
                'name' => 'Recettes', // Nom au pluriel
                'singular_name' => 'Recette' // Nom au singulier
            ],
            'public' => true, // Valeur par défaut
            ...
            'has_archive' => true,
            // Dans le commit précédent on pouvait retrouver nos recettes avec l'url finissant par localhost.../recipe/ a présent grâce au rewrite et a son paramètre slug on peut changer le slug de notre url pour que ce soit localhost.../recette/
